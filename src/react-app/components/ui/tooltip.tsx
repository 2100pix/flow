    ...
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Positioner align={align} alignOffset={alignOffset} side={side} sideOffset={sideOffset} className="isolate z-50">
        <TooltipPrimitive.Popup
          ...
          className={cn(
            "z-50 overflow-hidden rounded-xl border border-white/10 bg-[#1f2125] px-3 py-2 text-sm font-medium text-white shadow-[0_10px_30px_rgba(0,0,0,0.35)] backdrop-blur-sm",
